...
function signinfo() {
  return new Promise((resolve) => {
      ...
      const url = {
          url: `https://my.ruanmei.com/api/usersign/getsigninfo?userHash=${userHash}&type=3`,
          headers: {},
      };
...
function getUrl() {
  const userHash = $.getdata($.userHash);
  return `https://my.ruanmei.com/api/usersign/sign?userHash=${userHash}&type=3&timestamp=${now}&${gnekk()}=${geKsk()}`;
}
